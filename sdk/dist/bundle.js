var ChatDataSDK = (function (exports) {
    'use strict';
    ...
    const deleteMetadataSchema = objectType({
      type: literalType("DELETE_METADATA"),
      payload: objectType({
        key: stringType()
      })
    });
    const clearMetadataSchema = objectType({
      type: literalType("CLEAR_METADATA"),
      payload: objectType({}).optional()
    });
    class ChatEmbedClient {
      constructor(options = {}) {
    ...
    exports.ChatEmbedClient = ChatEmbedClient;
